...
public class SourceDao extends BaseDao<Source> {
	...
	public SourceDao(EntityManager entityManager) {
		super(entityManager);
	}

	@Override
	public void persist(Source entity) {
	...
	public List<Long> findAllIds() {
		TypedQuery<Long> query = entityManager.createNamedQuery("Source.findAllIds", Long.class);
	...
	public Source merge(Source source) {
		...
		Source merged = entityManager.merge(source);
